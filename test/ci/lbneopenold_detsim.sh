...
sed -e '/generator/s/^/#/g' -i.bak prodsingle_lbne35t.fcl 
sed -e '/largeant/s/^/#/g'  -i.bak prodsingle_lbne35t.fcl 
# These add lines back in
sed -e '/simulate\: /asimulate\: [ daq, rns ]' -i.bak prodsingle_lbne35t.fcl
sed -e '/RandomNumberGenerator/a  RandomNumberGenerator\: \{\} \# Added back ' -i.bak prodsingle_lbne35t.fcl
