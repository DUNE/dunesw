/**
 * @file   geometry_dunedphase10kt_test.cxx
 * @brief  Unit test for geometry on DUNE Far Detector (Dual Phase)
 * @date   October 21st, 2015
 * @author Gianluca Petrillo (petrillo@fnal.gov)
 * 
 * Usage:
 *     
 *     geometry_dunedphase10kt_test [ConfigurationFile [GeometryTestParameterSet]]
 *     
 * 
 * By default, `GeometryTestParameterSet` is set to
 * `"physics.analysers.geotest"`.
 * 
 */
...
using DUNEFDDPGeometryConfiguration
  = dune::testing::DUNEFDDPGeometryEnvironmentConfiguration
    <geo::ChannelMapCRMAlg>;
 ...
 */
using DUNEFDDPGeometryTestEnvironment
  = testing::GeometryTesterEnvironment<DUNEFDDPGeometryConfiguration>;
...
int main(int argc, char const** argv) {
  ...
  DUNEFDDPGeometryConfiguration config("geometry_test_DUNEFD_DP");
  ...
  //
  DUNEFDDPGeometryTestEnvironment TestEnvironment(config);
