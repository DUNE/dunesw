 ...
 */
using DUNEFDGeometryTestFixture
...
// BOOST_FIXTURE_TEST_SUITE(GeometryIterators, DUNEFDGeometryTestFixture)
BOOST_GLOBAL_FIXTURE(DUNEFDGeometryTestFixture)
...
BOOST_AUTO_TEST_CASE( CryostatIteratorsTest )
{
  ...
  geo::GeometryCore const* geom = DUNEFDGeometryTestFixture::GlobalGeometry();
