/**
 * @file   geometry_iterator_loop_dunefd_test.cxx
 * @brief  Test for geometry iterator loops on DUNE Far Detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   geometry_iterator_loop_dunefd_test  [ConfigurationFile [GeometryTestParameterSet]]
 * 
...
int main(int argc, char const** argv) {
  ...
  DUNEFDGeometryConfiguration config("geometry_iterator_loop_test_DUNEFD");
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_iterator_loop_test_DUNEFD")
