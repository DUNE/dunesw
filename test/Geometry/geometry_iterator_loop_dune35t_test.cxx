/**
 * @file   geometry_iterator_loop_dune35t_test.cxx
 * @brief  Test for geometry iterator loops on "optimized" DUNE 35t detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   `geometry_iterator_loop_dune35t_test [ConfigurationFile [GeometryTestParameterSet]]`
 * 
...
int main(int argc, char const** argv) {
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_iterator_loop_test_DUNE35t")
